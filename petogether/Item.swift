...
final class PhotoRecord {
    var id: UUID
    var imageUrl: String  // 照片存储路径
    var sceneCategory: String  // 场景分类
    var sceneSubcategory: String  // 场景子分类
    var aiAnalysisResult: String?  // AI分析结果
    var timestamp: Date
    
    init(id: UUID = UUID(), imageUrl: String, sceneCategory: String, sceneSubcategory: String, aiAnalysisResult: String? = nil, timestamp: Date = Date()) {
        self.id = id
